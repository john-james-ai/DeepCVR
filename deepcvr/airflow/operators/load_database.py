...
# Modified : Saturday, February 26th 2022, 10:14:25 pm                                             #
...
from deepcvr.utils.io import read_csv
...
class LoadImpressionsOperator(BaseOperator):
    ...
    def execute(self, context=None) -> None:
        ...
        # Obtain core data
        df = read_csv(filepath=self._filepath, sep=",", header=None, index_col=False)
