...
# Modified : Sunday, February 27th 2022, 9:52:27 am                                                #
...
from deepcvr.airflow.operators.extract import GZIPExtractOperator
...
def test_extract_operator_execute_no_trigger(dag, reset_db):
    reset_db
